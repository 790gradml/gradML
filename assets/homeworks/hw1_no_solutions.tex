...
\part (Empirics) From train.csv, what is your maximum likelihood estimate for $P(y = 0)$ and $P(y = 1)$? What is your estimate for $\mu_1$ and $\mu_2$?  What is your estimate for $\Sigma_1$ and $\Sigma_2$? Do you notice something about $\Sigma_1$ and $\Sigma_2$?  (Hint: Don't overthink)

\part (Theory) What is $P(y = 1|x)$ and $P(y = 0|x)$ proportional to
  as a function of $y$?
...
\end{equation}
Here we compare the log likelihood as it simplifies the derivation.  Is this decision boundary (as a function of $x$) linear, quadratic, etc.?  How does the decision boundary simplify when $\Sigma_1 = \Sigma_2$?


\part (Empirics) Using the decision boundary derived in part (c), classify the points in test.csv as $y = 0$ or $1$.  
